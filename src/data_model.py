...
class GenericStaticVcenterVMShell2G(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Generic Static vCenter VM Shell 2G'
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :return:
        :rtype GenericStaticVcenterVMShell2G
        """
        result = GenericStaticVcenterVMShell2G(name=context.resource.name)
    ...
    def cloudshell_model_name(self):
        ...
        :return:
        """
        return 'GenericStaticVcenterVMShell2G'
    ...
    def vm_name(self):
        ...
        :rtype: str
        """
        return self.attributes['Generic Static vCenter VM Shell 2G.VM Name'] if 'Generic Static vCenter VM Shell 2G.VM Name' in self.attributes else None
    ...
    def vm_name(self, value):
        ...
        :type value: str
        """
        self.attributes['Generic Static vCenter VM Shell 2G.VM Name'] = value
    ...
    def vcenter_resource_name(self):
        ...
        :rtype: str
        """
        return self.attributes['Generic Static vCenter VM Shell 2G.vCenter Resource Name'] if 'Generic Static vCenter VM Shell 2G.vCenter Resource Name' in self.attributes else None

    @vcenter_resource_name.setter
    def vcenter_resource_name(self, value):
        """
        Name of the existing vCenter Resource
        :type value: str
        """
        self.attributes['Generic Static vCenter VM Shell 2G.vCenter Resource Name'] = value
    ...
    def vcenter_port(self):
        ...
        :rtype: float
        """
        return self.attributes['Generic Static vCenter VM Shell 2G.vCenter Port'] if 'Generic Static vCenter VM Shell 2G.vCenter Port' in self.attributes else None
    ...
    def vcenter_port(self, value='443'):
        ...
        :type value: float
        """
        self.attributes['Generic Static vCenter VM Shell 2G.vCenter Port'] = value
    ...
    def user(self):
        ...
        :rtype: str
        """
        return self.attributes['Generic Static vCenter VM Shell 2G.User'] if 'Generic Static vCenter VM Shell 2G.User' in self.attributes else None
    ...
    def user(self, value):
        ...
        :type value: str
        """
        self.attributes['Generic Static vCenter VM Shell 2G.User'] = value
    ...
    def password(self):
        ...
        :rtype: string
        """
        return self.attributes['Generic Static vCenter VM Shell 2G.Password'] if 'Generic Static vCenter VM Shell 2G.Password' in self.attributes else None
    ...
    def password(self, value):
        ...
        :type value: string
        """
        self.attributes['Generic Static vCenter VM Shell 2G.Password'] = value
    ...
    def public_ip(self):
        ...
        :rtype: str
        """
        return self.attributes['Generic Static vCenter VM Shell 2G.Public IP'] if 'Generic Static vCenter VM Shell 2G.Public IP' in self.attributes else None
    ...
    def public_ip(self, value):
        ...
        :type value: str
        """
        self.attributes['Generic Static vCenter VM Shell 2G.Public IP'] = value
...
class GenericVPort(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Generic Static vCenter VM Shell 2G.GenericVPort'
        self._name = name
    ...
    def requested_vnic_name(self):
        ...
        :rtype: str
        """
        return self.attributes['Generic Static vCenter VM Shell 2G.GenericVPort.Requested vNIC Name'] if 'Generic Static vCenter VM Shell 2G.GenericVPort.Requested vNIC Name' in self.attributes else None

    @requested_vnic_name.setter
    def requested_vnic_name(self, value):
        """
        Interface vnic number
        :type value: str
        """
        self.attributes['Generic Static vCenter VM Shell 2G.GenericVPort.Requested vNIC Name'] = value
    ...
    def bandwidth(self):
        ...
        :rtype: float
        """
        return self.attributes['Generic Static vCenter VM Shell 2G.GenericVPort.Bandwidth'] if 'Generic Static vCenter VM Shell 2G.GenericVPort.Bandwidth' in self.attributes else None
    ...
    def bandwidth(self, value):
        ...
        :type value: float
        """
        self.attributes['Generic Static vCenter VM Shell 2G.GenericVPort.Bandwidth'] = value
    ...
    def mac_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Generic Static vCenter VM Shell 2G.GenericVPort.MAC Address'] if 'Generic Static vCenter VM Shell 2G.GenericVPort.MAC Address' in self.attributes else None
    ...
    def mac_address(self, value):
        ...
        :type value: str
        """
        self.attributes['Generic Static vCenter VM Shell 2G.GenericVPort.MAC Address'] = value
    ...
    def ip_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Generic Static vCenter VM Shell 2G.GenericVPort.IP Address'] if 'Generic Static vCenter VM Shell 2G.GenericVPort.IP Address' in self.attributes else None
    ...
    def ip_address(self, value):
        ...
        :type value: str
        """
        self.attributes['Generic Static vCenter VM Shell 2G.GenericVPort.IP Address'] = value
